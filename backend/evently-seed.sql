...
INSERT INTO Messages (group_id, sender_id, content, time_sent)
VALUES
  (1, 1, 'Hello, how is everyone?', '2023-08-11 11:34:04.17' ),
  (1, 2, 'I''m doing great, thanks!','2023-08-11 11:34:04.17' ),
  (1, 3, 'Anyone up for an event this weekend?','2023-08-11 11:34:04.17' ),
  (2, 4, 'I have some exciting news to share 222!','2023-08-11 11:34:04.17' ),
  (2, 5, 'Tell us, we''re curious22!', '2023-08-11 11:34:04.17'),
  (2, 6, 'Can''t wait to hear it22!','2023-08-11 11:34:04.17' ),
  (3, 7, 'Reminder: our next meeting is on Friday.', '2023-08-11 11:34:04.17'),
  (3, 8, 'Thanks for the heads up!', '2023-08-11 11:34:04.17'),
  (3, 9, 'I might be late, but I''ll catch up.', '2023-08-11 11:34:04.17'),
  (1, 10, 'Has anyone seen my keys?', '2023-08-11 11:34:04.17'),
  (1, 11, 'Not sure, check the living room.' ,'2023-08-11 11:34:04.17'),
  (1, 12, 'I''ll help you look for them.' ,'2023-08-11 11:34:04.17'),
  -- Additional rows for each grou
  (1, 13, 'Let''s plan a group trip!', '2023-08-11 11:34:04.17'),
  (1, 14, 'Great idea! Where should we go?','2023-08-11 11:34:04.17' ),
  (1, 15, 'I suggest visiting the beach.' ,'2023-08-11 11:34:04.17'),
  (1, 16, 'I''m up for a beach trip!','2023-08-11 11:34:04.17' ),
  (2, 17, 'Who wants to join me for a movie night22?' ,'2023-08-11 11:34:04.17'),
  (2, 18, 'I''m in! What movie are we watching?22' ,'2023-08-11 11:34:04.17'),
  (2, 19, 'I''ll bring the popcorn!22','2023-08-11 11:34:04.17' ),
  (2, 20, 'Count me in too!22','2023-08-11 11:34:04.17' ),
  (3, 1, 'Let''s organize a potluck dinner.','2023-08-11 11:34:04.17' ),
  (3, 2, 'I''m a great cook, count me in!','2023-08-11 11:34:04.17' ),
  (3, 3, 'I''ll bring my famous dessert.', '2023-08-11 11:34:04.17'),
  (3, 4, 'I''ll make a savory dish.','2023-08-11 11:34:04.17' ),
  (3, 5, 'Looking forward to it!', '2023-08-11 11:34:04.17'),
  -- Additional rows for each grou
  (1, 6, 'We should start a book club.','2023-08-11 11:34:04.17' ),
  (1, 7, 'I''m an avid reader, I''m in!','2023-08-11 11:34:04.17' ),
  (1, 8, 'What genre should we focus on?','2023-08-11 11:34:04.17' ),
  (1, 9, 'I love mystery novels.' ,'2023-08-11 11:34:04.17'),
  (2, 10, 'Let''s plan a hiking trip!22','2023-08-11 11:34:04.17' ),
  (2, 11, 'I know a great trail22','2023-08-11 11:34:04.17');
