...
VALUES
  ...
  (2, 4, 'I have some exciting news to share 222!' ),
  (2, 5, 'Tell us, we''re curious22!' ),
  (2, 6, 'Can''t wait to hear it22!' ),
  ...
  (2, 17, 'Who wants to join me for a movie night22?' ),
  (2, 18, 'I''m in! What movie are we watching?22' ),
  (2, 19, 'I''ll bring the popcorn!22' ),
  (2, 20, 'Count me in too!22' ),
  ...
  (2, 10, 'Let''s plan a hiking trip!22' ),
  (2, 11, 'I know a great trail22');
